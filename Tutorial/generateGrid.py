...
the name of the configuration file, and the second specifies the MoogStokesPy
shared object (ALPHA, BRAVO, CHARLIE, DELTA...), in the event that you would
like to run more than one instance of generateGrid (useful on machines with
more than one core)
